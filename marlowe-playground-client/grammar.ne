...
topContract
   -> hole {% ([hole]) => hole %}
    ...
    | "Mint" someWS payee someWS token someWS contract {% ([{line, col},,payee,,token,,contract]) => opts.mkTerm(opts.mkMint(payee)(token)(contract))({startLineNumber: line, startColumn: col, endLineNumber: opts.getRange(contract).endLineNumber, endColumn: opts.getRange(contract).endColumn}) %}
    | "Burn" someWS payee someWS token someWS contract {% ([{line, col},,payee,,token,,contract]) => opts.mkTerm(opts.mkBurn(payee)(token)(contract))({startLineNumber: line, startColumn: col, endLineNumber: opts.getRange(contract).endLineNumber, endColumn: opts.getRange(contract).endColumn}) %}
...
contract
   -> hole {% ([hole]) => hole %}
    ...
    | lparen "Mint" someWS payee someWS token someWS contract rparen {% ([start,{line, col},,payee,,token,,contract,end]) => opts.mkTerm(opts.mkMint(payee)(token)(contract))({startLineNumber: start.line, startColumn: start.col, endLineNumber: end.line, endColumn: end.col}) %}
    | lparen "Burn" someWS payee someWS token someWS contract rparen {% ([start,{line, col},,payee,,token,,contract,end]) => opts.mkTerm(opts.mkBurn(payee)(token)(contract))({startLineNumber: start.line, startColumn: start.col, endLineNumber: end.line, endColumn: end.col}) %}
