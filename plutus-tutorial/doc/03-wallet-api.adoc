...
link:{haddock}/plutus-playground-server-0.1.0.0/html/Playground-Contract.html#v:mkFunctions[`mkFunctions`]
...
link:{haddock}/plutus-playground-server-0.1.0.0/html/Playground-Contract.html#v:mkFunctions[`mkFunctions`]
is defined in a different library (`plutus-playground-server`) and it is
