...
import qualified Language.PlutusCore.Untyped.Instance.Pretty                   ()
...
import           Language.Marlowe.Semantics                                    as Marlowe (marloweValidator, Input, MarloweData)
...
-- defaultMarloweValidator :: 
               
main :: IO()
main = do
  putStrLn . show . prettyPlcClassicDef $ PlutusTx.getPlc compiledMarloweValidator
{-
  ...
  process    "Marlowe"              compiledMarloweValidator
-}
